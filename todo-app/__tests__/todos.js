...
describe('Todo Application', function () {
  ...
  test('Marks a todo with the given ID as complete', async () => {
    ...
    if (latestTodo && latestTodo.id) {
      ...
      // Handle the case where there is no todo or no id
      // You may want to log an error or fail the test
      console.error('No todo found or todo has no id.')
      expect(true).toBe(false) // Failing the test
    }
  })
